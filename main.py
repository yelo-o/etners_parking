...
# 제목 라벨
title_label = customtkinter.CTkLabel(master=frame, text="차량번호입력", font=("Roboto", 24))
...
# 아래의 차량 번호 리스트 업데이트 필요 <- 웹에서 실시간으로 받아와야 하는 자료
car_numbers=['236수8859', '281나8558', '285수5683', '145버7854', '173보8500', '36보3853', '153조8560', '38루2855', '128주1856', '68나7853']
combobox = customtkinter.CTkOptionMenu(master=frame, values=car_numbers, command=optionmenu_callback)
