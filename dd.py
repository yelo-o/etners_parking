...
frame1.pack(fill=ttk.BOTH, side=ttk.LEFT, expand=True)
frame2 = ttk.Frame(bootstyle="light")
# frame2.pack(side="right",fill='both', expand=True)
frame2.pack(fill=ttk.BOTH, side=ttk.LEFT, expand=True)
frame3 = ttk.Frame(bootstyle="light")
# frame3.pack(side="bottom",fill='none', expand=True)
frame3.pack(fill=ttk.BOTH, side=ttk.LEFT, expand=True)
